...
func (h *KubeDBHandler) CreateMySql(w http.ResponseWriter, r *http.Request) {

	var req MySqlCreateRequest
	...
	// 🔥 RUN INSTALL ASYNC
	go installer.InstallMySql(record)

	json.NewEncoder(w).Encode(map[string]string{
		"status": "MySql creation started",
	})
}
